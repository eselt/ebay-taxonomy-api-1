...
class Aspect implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['relevance_indicator'] = isset($data['relevance_indicator']) ? $data['relevance_indicator'] : null;
    }
     ...
     * Sets aspect_values
     *
     * @param \OpenAPI\Client\Model\AspectValue[]|null $aspect_values A list of valid values for this aspect (for example: Red, Green, and Blue), along with any constraints on those values.
     *
     * @return $this
     */
