...
class CategoryTreeNode implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \OpenAPI\Client\Model\CategoryTreeNode[]|null $child_category_tree_nodes An array of one or more category tree nodes that are the immediate children of the current category tree node, as well as their children, recursively down to the leaf nodes. Returned only if the current category tree node is not a leaf node (the value of leafCategoryTreeNode is false).
     *
     * @return $this
     */
